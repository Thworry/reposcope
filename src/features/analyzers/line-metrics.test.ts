...
describe("Markdown evidence", () => {
  ...
  it.each([
    ...
    ["bare command", "## Usage\nnpm start", false],
    ["environment command", "## Usage\nNODE_ENV=prod npm start", false],
    ["sudo command", "## Usage\nsudo npm start", false],
    ["const declaration", "## Usage\nconst app = run()", false],
    ["let declaration", "## Usage\nlet app = run()", false],
    ["var declaration", "## Usage\nvar app = run()", false],
    ["assignment", "## Usage\napp = run()", false],
    ["JavaScript import", "## Usage\nimport { run } from './app.js'", false],
    ["Python import", "## Usage\nfrom app import run", false],
    ["executable path", "## Usage\n./scripts/run.sh", false],
    ["sudo flags", "## Usage\nsudo -u app npm start", false],
    ["env flags", "## Usage\nenv -i npm start", false],
    ...
    ["Python raise", '## Usage\nraise RuntimeError("failed")', false],
    ["Python yield", "## Usage\nyield analyze()", false],
    ["Python assert", "## Usage\nassert result", false],
    ["Python if", "## Usage\nif ready:", false],
    ["Python elif", "## Usage\nelif ready:", false],
    ...
    ["Python async for", "## Usage\nasync for item in items:", false],
    ["Python while", "## Usage\nwhile ready:", false],
    ["Python def", "## Usage\ndef analyze(repo):", false],
    ["Python async def", "## Usage\nasync def analyze(repo):", false],
    ["Python class", "## Usage\nclass Client:", false],
    ["Python with", "## Usage\nwith open(path):", false],
    ["Python async with", "## Usage\nasync with client.session():", false],
    ["Python try", "## Usage\ntry:", false],
    ["Python except", "## Usage\nexcept RuntimeError:", false],
    ["Python finally", "## Usage\nfinally:", false],
    ["Python match", "## Usage\nmatch command:", false],
    ["Python case", '## Usage\ncase "run":', false],
    ["code fence", "## Usage\n```sh\nnpm start\n```", false],
    ...
    [
      "English API call explanation",
      "## Usage\nCall analyze() with a public repository URL.",
      true,
    ],
    [
