...
const baseEn = {
  ...
  deepCommunityIssues: "Open issues",
...
const baseZh = {
  ...
  readerClaimObservationHeading: "README 声明与仓库观察",
  ...
  readerReadmeProblemsSubheading: "描述的问题",
  readerReadmeUseCasesSubheading: "描述的使用场景",
  readerReadmeDependenciesSubheading: "要求与依赖",
  readerReadmeLimitationsSubheading: "声明的限制",
  ...
  readerComparisonSourceAreasHeading: "顶层源码区域",
  readerComparisonClaimsMissing:
    "已扫描的 README 证据没有提供可供对照的宽泛声明。",
  readerComparisonObservationsMissing:
    "已扫描的仓库证据无法形成宽泛的结构观察。",
  readerCommentaryWorthHeading: "值得注意",
  ...
  deepExpertIndex: "可选专家简报",
  deepExpertHeading: "一份真正给人读的第二意见",
  deepExpertIntro:
    "评审会先读 README，再核对仓库自身证据、质疑薄弱结论，最后整理成一份实用简报。下方的确定性报告始终保留。",
  deepChecking: "正在检查专家解读是否可用……",
  deepGenerate: "生成专家解读",
  deepRegenerate: "重新生成专家解读",
  deepDisclosureHeading: "专家组开始之前",
  deepDisclosureEvidence:
    "这个公开项目中选定的 README、文档、清单和 GitHub 公开事实会发送给 GitHub Copilot。",
  deepDisclosureAllowance:
    "本次分析使用你的 GitHub Copilot 权益，并可能计入相应使用额度。",
  deepDisclosureNoExecution:
    "RepoScope 不会执行项目代码、安装依赖、运行命令，也不会给专家组任何工具。",
  deepDisclosureFallback:
    "即使授权或专家组失败，浏览器里的确定性报告也不会受影响。",
  deepConsentConfirm: "同意并使用 GitHub 继续",
  deepConsentCancel: "暂不使用",
  deepAutomatic: "以后搜索其他项目时自动生成",
  deepAutomaticHelp:
    "浏览器只保存这个偏好；GitHub 凭据只存在于短时服务端会话中。",
  deepSignOut: "退出专家模式",
  deepCancel: "取消专家分析",
  deepRetry: "重新尝试专家分析",
  deepReadyNote: "已准备解读当前固定提交；原有评分和证据不会被修改。",
  deepErrorCopilot:
    "当前账号或会话无法使用 GitHub Copilot；确定性报告仍然完整。",
  deepErrorAllowance: "当前 Copilot 额度无法完成简报；确定性报告没有变化。",
  deepErrorRateLimit: "专家分析已达到临时启动上限，请稍后重试。",
  deepErrorRepository:
    "项目在浏览器扫描后发生了变化，请先刷新公开数据再生成简报。",
  deepErrorGitHub: "GitHub 暂时无法提供本次简报所需的有限公开证据。",
  deepErrorEvidence:
    "专家输出没有通过 RepoScope 的证据与安全校验，因此不会展示。",
  deepErrorCancelled: "专家分析已取消。",
  deepErrorInternal: "专家分析未能完成；确定性报告仍然可用。",
  deepProgressHeading: "专家组正在工作",
  deepProgressLabel: "专家分析进度",
  deepStagePreparing: "准备公开证据",
  deepStageConsulting: "咨询三位专项专家",
  deepStageChallenging: "质疑初步结论",
  deepStageEditing: "编辑最终简报",
  deepStageValidating: "逐条核验证据",
  deepProgressPending: "等待中",
  deepProgressRunning: "进行中",
  deepProgressComplete: "已完成",
  deepProgressFailed: "未能完成",
  deepProgressReused: "复用已核验简报",
  deepProgressCacheHit:
    "已找到保存的简报；RepoScope 正在刷新公开事实并重新核验证据来源。",
  deepRoleProduct: "产品与实际场景解读",
  deepRoleOnboarding: "上手与整体架构评审",
  deepRoleTrust: "可信度、维护和替代方案评审",
  deepReportIndex: "专家解读",
  deepReportHeading: "项目简报",
  deepReportMethod:
    "以 README 为起点，并用固定提交中的仓库证据逐条核对；缺少依据的说法会明确标为“尚未确认”。",
  deepCoverageFull: "完整专家覆盖",
  deepCoverageReduced: "部分专家覆盖",
  deepCapabilityAuto: "GitHub 自动选择模型",
  deepCapabilityMulti: "多个可用模型家族",
  deepChapterOrientation: "30 秒看懂项目",
  deepChapterFit: "适合谁 / 不适合谁",
  deepChapterSituations: "具体使用场景",
  deepChapterCapabilities: "能力与使用流程",
  deepChapterArchitecture: "大体如何工作",
  deepChapterOnboarding: "安装、运行与二次开发",
  deepChapterTrust: "可靠性、安全与隐私",
  deepChapterMaintenance: "维护状态与社区",
  deepChapterAlternatives: "值得对比的替代项目",
  deepChapterVerdict: "专家结论",
  deepGoodFor: "适合",
  deepPoorFor: "不适合",
  deepCapabilities: "核心能力",
  deepWorkflow: "典型流程",
  deepArchitectureSummary: "产品形态",
  deepArchitectureTechnologies: "技术体系",
  deepArchitectureConcepts: "核心概念",
  deepPrerequisites: "前置条件",
  deepInstall: "安装",
  deepRun: "运行",
  deepDevelop: "二次开发",
  deepCautions: "执行任何操作前的提醒",
  deepReliability: "可靠性信号",
  deepSecurity: "安全",
  deepPrivacy: "隐私",
  deepUnknowns: "尚未确认",
  deepMaintenanceSignals: "观察到的维护信号",
  deepCommunityStars: "Star",
  deepCommunityWatchers: "Watch",
  deepCommunityForks: "Fork",
  deepCommunityIssues: "开放 Issue",
  deepCommunityPush: "最近推送",
  deepCommunityArchived: "是否归档",
  deepCommunityLicense: "许可证",
  deepPopularityCaveat:
    "热度只代表关注，不等于可靠、安全，也不代表适合你的场景。",
  deepAlternativeRepository: "项目",
  deepAlternativeWhy: "为什么值得对比",
  deepAlternativeActivity: "社区与活跃度",
  deepAlternativesUnavailable: "本次简报没有可供核验的替代项目。",
  deepDisagreements: "专家组质疑了什么",
  deepNextChecks: "你接下来应该核实什么",
  deepDecisionWorthTrying: "值得尝试",
  deepDecisionCompareFirst: "先做对比",
  deepDecisionNotEnough: "证据不足",
  deepEvidenceDrawer: "这份简报引用的证据",
  deepEvidenceOpen: "打开固定版本来源",
  deepEvidenceUnavailable: "没有可用来源链接",
  deepProvenanceRepository: "项目方声称",
  deepProvenanceObserved: "仓库显示",
  deepProvenanceInterpretation: "专家解读",
  deepProvenanceUnknown: "尚未确认",
  deepConfidenceHigh: "高置信度",
  deepConfidenceMedium: "中等置信度",
  deepConfidenceLow: "低置信度",
  privacyOptional:
    "确定性扫描仍在此浏览器中完成；只有授权后的专家简报会把选定公开证据发送给 GitHub Copilot。",
  privacyOptionalMark: "浏览器 / 可选 COPILOT",
  methodologyBoundaryOptional:
    "项目源码仍是不可信文本且绝不执行。确定性扫描在本地完成；只有授权后的专家运行会把选定公开证据发送给零工具的 GitHub Copilot 会话。",
